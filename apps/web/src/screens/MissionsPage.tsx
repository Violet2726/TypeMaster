...
import { AppButton, AppCommandDeck, SectionHeader } from '../components/app/AppPrimitives';
    ...
    return (
        <div className="page-stack page-stack--home">
            <AppCommandDeck
                ...
                aside={(
                    <div className="mission-command__aside" aria-label={missionCopy.progressLabel}>
                        <div className="mission-command__status-grid">
